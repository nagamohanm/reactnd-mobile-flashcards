...
export const SmallBlueText = styled.Text`
  ...
  text-align: center;
`
export const GreenLightView = GreenView.extend`background-color: ${lightgreen};`
...
export const ButtonRed = Button.extend`background-color: ${mediumdarkred};`

export const BlueText = BigBlueText.extend`font-size: 30px;`

export const BlueButtonText = ButtonText.extend`color: ${darkblue};`
